...
32"""
    ...
    def test_example_case(self):
        ...
        fresh_ingredients, available_ingredients = Part01.read_input(
            self.temp_file.name
        )
    ...
    def test_is_available_also_fresh(self):
        ...
        self.assertTrue(
            Part01.is_availble_also_fresh(5, fresh_ranges),
            "5 should be fresh (in range 3-5)",
        )
        self.assertTrue(
            Part01.is_availble_also_fresh(11, fresh_ranges),
            "11 should be fresh (in range 10-14)",
        )
        self.assertTrue(
            Part01.is_availble_also_fresh(17, fresh_ranges),
            "17 should be fresh (in overlapping ranges)",
        )

        # Test spoiled ingredients
        self.assertFalse(
            Part01.is_availble_also_fresh(1, fresh_ranges), "1 should be spoiled"
        )
        self.assertFalse(
            Part01.is_availble_also_fresh(8, fresh_ranges), "8 should be spoiled"
        )
        self.assertFalse(
            Part01.is_availble_also_fresh(32, fresh_ranges), "32 should be spoiled"
        )
    ...
    def test_overlapping_ranges(self):
        ...
        for i in range(10, 19):
            self.assertTrue(
                Part01.is_availble_also_fresh(i, fresh_ranges),
