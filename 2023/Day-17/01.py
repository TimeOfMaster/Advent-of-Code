...
def a_star(start_state, goal_pos, min_chain_before_turn, max_chain):
    ...
    while not q.empty():
        ...
        for nbr_state in get_nbrs(current_state):
            ...
            q.put((dist[nbr_state] + heuristic(nbr_state), nbr_state))
